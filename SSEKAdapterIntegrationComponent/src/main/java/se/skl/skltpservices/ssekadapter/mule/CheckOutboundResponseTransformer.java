...
import se.skl.skltpservices.ssekadapter.mapper.error.SSEKAdapterError;
import se.skl.skltpservices.ssekadapter.mapper.error.OutboundResponseException;
...
public class CheckOutboundResponseTransformer extends AbstractMessageTransformer {
    ...
    public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
        ...
        if (payload == null) {
            throw new TransformerException(this, new OutboundResponseException("Null payload after calling outbound service", SSEKAdapterError.OUTBOUNDRESPONSE_NULL));
        } else {
            ...
            if (payload instanceof UpdateResponseType) {
                if (((UpdateResponseType) payload).getResultCode() == ResultCodeEnum.ERROR) {
                    ...
                    throw new TransformerException(this, new OutboundResponseException(msg, SSEKAdapterError.INDEXUPDATE));
                }
                log.debug("EI Update response is OK");
            } else if (payload instanceof Boolean) {
                if (!(Boolean) payload) {
                    throw new TransformerException(this, new OutboundResponseException("SendStatus call to NPOv1 producer failed", SSEKAdapterError.INDEXUPDATE_SENDSTATUS));
                }
                ...
                throw new TransformerException(this, 
                                               ...
                                               SSEKAdapterError.OUTBOUNDRESPONSE_UNRECOGNISED));
            }
        }
        return message;
    }
