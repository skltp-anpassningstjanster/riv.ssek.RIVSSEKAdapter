...
public class MapperException extends AdapterException {
	...
	public MapperException(final String message, final SSEKAdapterError errorCode) {
		super(message, errorCode);
	}
	public MapperException(final String message, final Exception cause, final SSEKAdapterError errorCode) {
