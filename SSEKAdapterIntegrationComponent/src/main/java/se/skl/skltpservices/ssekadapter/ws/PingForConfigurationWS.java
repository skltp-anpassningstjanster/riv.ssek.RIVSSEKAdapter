 ...
 */
package se.skl.skltpservices.ssekadapter.ws;
...
import se.skl.skltpservices.ssekadapter.mapper.util.SSEKUtil;
import se.skl.skltpservices.ssekadapter.util.Sample;
import se.skl.skltpservices.ssekadapter.util.Samples;
...
public class PingForConfigurationWS implements PingForConfigurationResponderInterface {
    ...
    public PingForConfigurationResponseType pingForConfiguration(String logicalAddress, PingForConfigurationType request) {
        ...
        response.setVersion(RegisterMedicalCertificateType.class.getPackage().getImplementationVersion());
        response.setPingDateTime(SSEKUtil.formatTimestamp(new Date()));
