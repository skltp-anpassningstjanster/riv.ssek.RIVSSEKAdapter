...
public class OutboundResponseException extends AdapterException {
    ...
    public OutboundResponseException(final String message, SSEKAdapterError errorCode) {
    	super(message, errorCode);
    }
    
    public OutboundResponseException(final String message, Exception cause, SSEKAdapterError errorCode) {
